...
namespace BasicAnimations
{
    internal class Animations
    {
        ...
        internal static Animation Sit = new Animation("anim@amb@business@bgen@bgen_no_work@", "sit_phone_phoneputdown_idle_nowork", String.Empty, String.Empty,  "get_up@sat_on_floor@to_stand", "getup_0", true, false, 0, AnimationStage.None, false);
        ...
        internal static Animation GrabBelt = new Animation("amb@world_human_cop_idles@male@idle_enter", "idle_intro", "amb@world_human_cop_idles@male@base", "base", String.Empty, String.Empty, true, false, 0, AnimationStage.None, false);
        internal static Animation GrabVest = new Animation("amb@world_human_hiker_standing@male@base", "base", String.Empty, String.Empty,  String.Empty, String.Empty, false, false, 0, AnimationStage.None, true);
        ...
        internal static Animation Mocking = new Animation("anim@mp_player_intcelebrationfemale@thumb_on_ears", "thumb_on_ears", String.Empty, String.Empty,  String.Empty, String.Empty, true, false, 0, AnimationStage.None, false);
